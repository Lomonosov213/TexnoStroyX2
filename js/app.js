...
/*
var d = document,
   ChooseHero = d.querySelector('.ChooseHero');
[].forEach.call(d.getElementsByName('Sand'), function (el) {
   el.addEventListener('click', function () {
      ChooseHero.appendChild(this.previousElementSibling.cloneNode());
...
*/
/*
const allLinks = document.querySelectorAll('.SK img');
...
$(".pop").click(function () {
   ...
   var vega = $(this).attr('src');
   console.log(vega);
   // var sss = $(".opo")
   // sss.attr("srca")
   $(".sec35__big").attr('src', vega);
